...
<div id="command-palette-modal" class="fixed inset-0 z-[60] overflow-y-auto p-4 sm:p-6 md:p-20 hidden pointer-events-none">
    <div class="mx-auto max-w-2xl transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black ring-opacity-5 transition-all pointer-events-auto">
        <div class="relative">
            ...
            <input type="text" id="command-palette-input" class="h-12 w-full border-0 bg-transparent pl-11 pr-4 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm" placeholder="Search clients, tasks, invoices, passwords… (Ctrl+K)" role="combobox" aria-expanded="false" aria-controls="options">
        </div>
