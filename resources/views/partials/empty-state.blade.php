...
<div class="text-center py-16 px-6 bg-white rounded-xl border border-dashed border-gray-300">
    <div class="mx-auto h-14 w-14 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-500 mb-4">
        @if($icon === 'users')
        ...
        @elseif($icon === 'payment')
        <svg class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
        @elseif($icon === 'credential')
    ...
    <a href="{{ $actionUrl }}" class="mt-6 inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700">{{ $actionLabel }}</a>
    @endif
</div>
