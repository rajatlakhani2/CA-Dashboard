...
<div class="max-w-6xl mx-auto space-y-6">
    <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-4 text-sm text-indigo-900 space-y-2">
        ...
        <p><strong>group_name</strong> = client reference / portfolio (e.g. <code class="bg-white/80 px-1 rounded">portfolio-a</code>). <strong>Services:</strong> comma-separated (e.g. <code class="bg-white/80 px-1 rounded">IT Return, GST Return</code>).</p>
    </div>
