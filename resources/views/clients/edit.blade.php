        ...
        <div id="panel-basic" class="tab-panel space-y-6">
            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" name="group_name" id="group_name" value="{{ old('group_name', $client->group_name) }}" placeholder="e.g. Portfolio A, Corporate" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-line placeholder:text-text-secondary focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
