...
if grep -q "Task UI v3" resources/views/tasks/create.blade.php && grep -q "Save task" resources/views/tasks/create.blade.php; then
  echo ""
  echo "SUCCESS: Create Task UI v3 (single screen) is on disk."
